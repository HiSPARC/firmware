...
-- Host name      : wijlre.
-- User name      : thei.
-- Time stamp     : Wed Apr 28 14:38:19 2010.
--
-- Designed by    : 
-- Company        : Translogic.
-- Design info    : 
...
--------------------------------------------------------------------------------
-- Architecture 'a0' of 'TRIGGER_STUFF'
-- Last modified : Wed Apr 28 11:04:30 2010.
--------------------------------------------------------------------------------
...
-- Last modified : Tue Apr 27 16:23:32 2010.
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Architecture 'a0' of 'DATA_CONTROLLER'
-- Last modified : Tue Apr 27 16:23:32 2010.
--------------------------------------------------------------------------------
...
-- Last modified : Tue Apr 27 15:03:34 2010.
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Architecture 'a0' of 'STORAGE_CHANNELS'
-- Last modified : Tue Apr 27 15:03:34 2010.
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Entity declaration of 'LEDS'.
-- Last modified : Wed Apr 28 11:50:52 2010.
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Entity declaration of 'DataMux'.
-- Last modified : Wed Apr 28 12:33:35 2010.
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Entity declaration of 'FPGA'.
-- Last modified : Wed Apr 28 12:54:44 2010.
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Entity declaration of 'TOP'.
-- Last modified : Tue Apr 27 15:23:43 2010.
--------------------------------------------------------------------------------
...
architecture a0 of TOP is
  ...
  signal DATA_POS_ADC0    :  std_logic_vector(11 downto 0);
  signal DCO_POS_ADC0     :  std_logic;
  signal DATA_NEG_ADC0    :  std_logic_vector(11 downto 0);
  signal DCO_NEG_ADC0     :  std_logic;
  signal DATA_POS_ADC_CH2 :  std_logic_vector(11 downto 0);
  signal DCO_POS_ADC_CH2  :  std_logic;
  signal DATA_NEG_ADC_CH2 :  std_logic_vector(11 downto 0);
  signal DCO_NEG_ADC_CH2  :  std_logic;
  signal CLK10MHz         :  std_logic;
  signal EXT_TR_IN        :  std_logic;
  signal USB_WR           :  std_logic;
  signal USB_TXE          :  std_logic;
  signal COMPL1           :  std_logic;
  signal COMPH1           :  std_logic;
  signal COMPL2           :  std_logic;
  signal COMPH2           :  std_logic;
  signal ONE_PPS          :  std_logic;
  signal USB_RD           :  std_logic;
  signal USB_RXF          :  std_logic;
  signal ADC_A0           :  std_logic;
  signal ADC_DATA         :  std_logic_vector(7 downto 0);
  signal SL1              :  std_logic;
  signal SH1              :  std_logic;
  signal SL2              :  std_logic;
  signal SH2              :  std_logic;
  signal SERIAL_NUMBER    :  std_logic_vector(9 downto 0);
  signal GPS_SDO          :  std_logic;
  signal GPS_SDI0         :  std_logic;
  signal CLK200MHz        :  std_logic;
  signal nSYSRST          :  std_logic;
  signal SPY_SDO0         :  std_logic;
  signal SPY_CON0         :  std_logic;
  signal SPY_SDI0         :  std_logic;
  signal USB_DATA_net     :  std_logic_vector(7 downto 0);
...
begin
  ...
  u0: FPGA
    port map(
      ...
      DAC_nRD => DAC_nRD,
      DAC_nWR => DAC_nWR,
      DATA_NEG_ADC_CH1 => DATA_NEG_ADC0,
      DATA_NEG_ADC_CH2 => DATA_NEG_ADC_CH2,
      DATA_POS_ADC_CH1 => DATA_POS_ADC0,
      DATA_POS_ADC_CH2 => DATA_POS_ADC_CH2,
      DCO_NEG_ADC_CH1 => DCO_NEG_ADC0,
      DCO_NEG_ADC_CH2 => DCO_NEG_ADC_CH2,
      DCO_POS_ADC_CH1 => DCO_POS_ADC0,
      DCO_POS_ADC_CH2 => DCO_POS_ADC_CH2,
      EXT_TR_IN => EXT_TR_IN,
      GPS_SDI => GPS_SDI0,
      GPS_SDO => GPS_SDO,
      HITLED1 => HITLED1,
